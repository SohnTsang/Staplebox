...
urlpatterns = [
    ...
    path('fetch_access_details/<str:product_uuid>/<int:partner_id>/', views.fetch_partner_access_details, name='fetch_access_details'),
    path('remove_access/<str:product_uuid>/<int:partner_id>/', views.remove_access, name='remove_access'),
